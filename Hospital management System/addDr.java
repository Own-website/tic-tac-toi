...
public class addDr implements ActionListener {
...
public addDr() 
	{
		...
		tfname.setBounds(235, 159, 167, 36);
		...
		tsname.setBounds(703, 159, 175, 36);
		...
		taddress.setBounds(233, 327, 648, 50);
		...
		String select[]={"select","Single","Marid"};
		...
		tjdate.setBounds(233, 595, 187, 42);
		...
		tldate.setBounds(703, 595, 175, 42);
		...
		tuname.setBounds(1138, 533, 180, 40);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		String ldate=tldate.getText();
		String uname=tuname.getText();
		String password=tupassword.getText();
		...
		if(e.getSource()==add)
		{
			try{
				...
				long a3=Long.parseLong(ph);
				Connection cn=Dao.mycon();
				PreparedStatement ps=cn.prepareStatement("insert into doctor values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
				ps.setInt(1,a1);
				...
				ps.setString(8, city);
				ps.setLong(9, a3);
				ps.setString(10, mstatus);
				ps.setString(11, jdate);
				ps.setString(12, ldate);
