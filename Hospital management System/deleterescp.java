...
public class deleterescp implements ActionListener {
...
public deleterescp() 
	...
	public static void main(String[] args) {
		deleterescp window = new deleterescp();
		...
		if(e.getSource()==bdelete)
		{
			...
			if(YesorNo==0)
			{
				try {
					...
					//int b1=Integer.parseInt(a1);
					Connection cn=Dao.mycon();
					PreparedStatement ps=cn.prepareStatement("delete from rescption where id=(?)");
					ps.setString(1,a1);
					ps.executeUpdate();
					frame.dispose();
					new frontpag();
