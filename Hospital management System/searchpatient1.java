...
public class searchpatient1 implements ActionListener{
	char a[];
	...
	private JButton blogout,back,search;
	...
	public searchpatient1() {
		...
		search.setBounds(1160, 134, 117, 40);
	...
	public static void main(String[] args) {
		searchpatient1 window = new searchpatient1();
