...
public addreceptionist() 
	{
		...
		l1 = new JLabel("Add Resceptionist");
		...
		blogout.setForeground(SystemColor.textHighlight);
		...
		badd.setFont(new Font("Tahoma", Font.BOLD, 20));
		badd.setBounds(1189, 113, 111, 40);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==badd)
		{
			try{
				...
				PreparedStatement ps=cn.prepareStatement("insert into rescption values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
				ps.setInt(1,a1);
				...
				ps.executeUpdate();
				cn.close();
				JOptionPane.showMessageDialog(taddress, "Successfull");
				frame.dispose();
				new rescpedetail();
				...
				JOptionPane.showMessageDialog(taddress, "Please fill the all correct entry ");
			}
		}
	}
}
